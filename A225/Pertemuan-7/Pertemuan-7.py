...
# def FungsiSegitiga(Alas,Tinggi):
#     Fungsi=0.5 * Alas* Tinggi
#     print(Fungsi)

# FungsiSegitiga(5,9)

# nama='ridho' #Variable Global sudah
...
# # def biodata1()
# #     print(username) #engga bisa karena dia diluar fungsi (varible lokal)
...
#     if nama=="" and nama == " " :
#         raise  ValueError ('Input Yang anda masukan kosong / Hanya Spasi')
